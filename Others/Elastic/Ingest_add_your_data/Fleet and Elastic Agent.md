...
3. **Go to Settings tab**: Configure:
	...
	2. [[#Agent output|Output for this Fleet Server agent]]. the `IP:port` that agents will use to send data. It can be, for instance, ElasticSearch or Logstash `IP:port`
